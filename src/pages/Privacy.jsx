  ...
  return (
    <div className="page narrow">
      <section className="legal-panel">
        ...
        <h2>AI Generation</h2>
        <p>When you generate a reviewer, uploaded or pasted study material is sent to the configured Gemini API endpoint so questions can be created. Large PDFs may be converted to text in your browser before the request is sent.</p>
        <h2>Diagnostics</h2>
        <p>The app may save recent error messages on your device so production problems can be debugged. These logs stay in browser storage unless you export a backup or clear them in Library.</p>
        <h2>Your Controls</h2>
